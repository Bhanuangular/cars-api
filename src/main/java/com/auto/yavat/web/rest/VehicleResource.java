...
/**
 * REST controller for managing {@link com.auto.yavat.domain.Vehicle}.
 */
@RestController
@RequestMapping("/api")
@Transactional
            ...
            .map(
                existingVehicle -> {
                    if (vehicle.getCar() != null) {
                        existingVehicle.setCar(vehicle.getCar());
                    }
                    ...
                    if (vehicle.getCondition() != null) {
                        existingVehicle.setCondition(vehicle.getCondition());
                    }
                    if (vehicle.getMinorIssues() != null) {
                        existingVehicle.setMinorIssues(vehicle.getMinorIssues());
                    }
                    ...
                    if (vehicle.getZipcode() != null) {
                        existingVehicle.setZipcode(vehicle.getZipcode());
                    }
